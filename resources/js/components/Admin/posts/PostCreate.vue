                        ...
                        <form class="form-horizontal" role="form" @submit.prevent="submit">
                            ...
                            <label for="title" class="col-md-2 control-label">Title</label>
                                ...
                                <!-- {!! Form::text('title', null, ['class' => 'form-control', 'required', 'autofocus']) !!} -->
                                    <input class="form-control" required="required" autofocus="autofocus" name="title" v-model="post.title" type="text" id="title">
                            ...
                            <div  v-bind:class="{ 'form-group': true, 'has-error' : errors.body }">
                                ...
                                <!-- {!! Form::textarea('body', null, ['class' => 'form-control', 'required']) !!} -->
                                        <textarea class="form-control" required="required" name="body" cols="50" v-model="post.body" rows="10" id="body"></textarea>
                            ...
                            <div  v-bind:class="{ 'form-group': true, 'has-error' : errors.category_id }">
                                <label for="category_id" class="col-md-2 control-label">Categories</label>
                                    <div class="col-md-8">
                                        ...
                                        <select class="form-control" required="required" id="category_id" name="category_id" v-model="post.category_id">
...
export default {
    ...
    methods: {
        submit() {
            axios.post('/admin/posts', this.post).then(response => {
                this.post = {};
                this.errors = {};
